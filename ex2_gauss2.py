...
if __name__ == "__main__":
    ...
    logger = utils.get_logger(logpath=os.path.join(args.save, "EG4logs_gauss2{}.txt".format(args.N)), filepath=os.path.abspath(__file__))
    h = 0.01
    # gen_data()
    ...
    pickle.dump(L, file)
    file.close()
    torch.save(net1, './experiments/model_EG4_2_gauss2_{}.pkl'.format(args.N))
