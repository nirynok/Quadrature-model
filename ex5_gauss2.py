...
if __name__ == "__main__":
    ...
    logger = utils.get_logger(logpath=os.path.join(args.save, "EGnon_logs_gauss2_{}_{}.txt".format(args.N, args.T)), filepath=os.path.abspath(__file__))
    # gen_data()
    ...
    pickle.dump(L, file)
    file.close()
    torch.save(net1, './experiments/model_EG_non_gauss2_{}_{}.pkl'.format(args.N, args.T))
